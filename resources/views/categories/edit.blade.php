    ...
    <div class="bg-white p-6 rounded-lg shadow-md max-w-4xl mx-auto">
        ...
        <form action="{{ route('categories.update', $category->id) }}" method="POST">
            ...
            <div class="mb-6 flex items-center space-x-3">
                <input type="checkbox" id="is_publish" name="is_publish" value="1" {{ old('is_publish', $category->is_publish) ? 'checked' : '' }}
            ...
            <div class="flex items-center space-x-4">
                <button type="submit" class="bg-blue-500 text-white px-6 py-3 rounded-lg hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50">Update</button>
